...
/**
 * v2.1 Sub-Index 구성:
 * - CEI: 자산회전율(25%) + 유형자산효율성(20%) + 현금수익률(20%) + ROIC(25%) + 추세(10%)
 * - RII: CAPEX강도(30%) + 투자괴리율(30%) + 재투자율(25%) + 지속성(15%)
 * - CGI: 현금활용도(20%) + 자금조달효율성(25%) + 주주환원균형(20%) + 현금적정성(15%) + 부채건전성(20%)
 * - MAI: 매출-투자동조성(30%) + 이익품질(25%) + 투자지속성(20%) + 성장투자비율(15%) + FCF추세(10%)
 */
export const SUB_INDEX_INFO = {
  ...
  RII: {
    ...
    components: 'CAPEX강도(30%) + 투자괴리율(30%) + 재투자율(25%) + 지속성(15%)'
  },
  CGI: {
  ...
  MAI: {
    ...
    label: '모멘텀 정합성',
    weight: 20,
    description: '매출 성장과 투자 방향이 일치하는지 평가합니다. 성장 투자 비율도 평가합니다.',
    components: '매출-투자동조성(30%) + 이익품질(25%) + 투자지속성(20%) + 성장투자비율(15%) + FCF추세(10%)'
  },
} as const;
