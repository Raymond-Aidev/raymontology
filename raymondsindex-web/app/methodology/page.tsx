    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          ...
          {/* RII */}
          <Card className="border-[#5E6AD2]/30 bg-[#5E6AD2]/5">
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <TrendingUp className="w-5 h-5 text-[#8B95E8]" />
                  RII (Reinvestment Intensity Index)
                  <Badge className="bg-[#5E6AD2]">핵심</Badge>
                </div>
                <Badge variant="outline" className="border-[#5E6AD2]/50 text-[#8B95E8]">가중치 40%</Badge>
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600 mb-4">
