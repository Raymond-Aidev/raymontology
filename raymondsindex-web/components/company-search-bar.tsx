  ...
  return (
    <div ref={containerRef} className={cn('relative', className)}>
      ...
      {isOpen && query.length >= 1 && (
        <div className="absolute top-full left-0 right-0 mt-1 bg-white rounded-lg border border-gray-200 shadow-xl shadow-gray-200/50 z-50 max-h-80 overflow-y-auto">
          {isLoading ? (
