          ...
          <div className="flex gap-12">
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li><Link href="/screener" className="hover:text-blue-600">스크리너</Link></li>
                <li><Link href="/methodology" className="hover:text-blue-600">평가 방법론</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-3">지원</h4>
              <ul className="space-y-2 text-sm text-gray-600">
                <li><a href="mailto:support@raymontology.com" className="hover:text-blue-600">문의하기</a></li>
              </ul>
            </div>
          </div>
        </div>
