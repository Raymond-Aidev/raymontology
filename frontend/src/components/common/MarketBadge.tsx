 ...
 * MarketBadge 컴포넌트
 *
 * 시장 구분(KOSPI/KOSDAQ/KONEX/ETF)을 색상 배지로 표시합니다.
 * RaymondsRisk 다크 테마에 최적화되어 있습니다.
 */
...
export function MarketBadge({
  ...
  return (
    <span
      className={`inline-flex items-center rounded font-medium whitespace-nowrap ${sizeClasses[size]} ${
...
export function TradingStatusBadge({
  ...
  return (
    <span
      className={`inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-medium bg-red-500 text-white ${className}`}
    >
