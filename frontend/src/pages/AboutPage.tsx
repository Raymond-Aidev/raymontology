        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a
                href="/raymondsrisktracking.pdf"
                download="RaymondsRisk_서비스소개서.pdf"
                className="w-full sm:w-auto px-8 py-3.5 bg-theme-surface hover:bg-theme-hover border border-theme-border text-text-primary font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
              >
