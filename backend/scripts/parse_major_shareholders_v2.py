...
INVALID_KEYWORDS = {
    ...
    # 직책명 (2026-01-05 추가) - 직책이 주주명으로 잘못 저장되는 문제 방지
    '사외이사', '사내이사', '이사', '감사', '대표이사', '상무', '전무', '부사장', '사장', '회장',
    '비상근이사', '상근감사', '비상근감사', '기타비상무이사', '감사위원',
    '상무이사', '전무이사', '부회장', '상무보', '이사회의장',
    # 비정상 키워드 (2026-01-05 추가) - 실제 주주명이 아닌 일반 용어
    '기타', '모회사', '자회사', '액면금액', '계열회사',
}
