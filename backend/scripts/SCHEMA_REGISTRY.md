...
> - affiliates: 973건
> - **financial_details: 10,355건** (RaymondsIndex용 상세 재무)
> - **raymonds_index: 7,646건** (자본 배분 효율성 지수 v2.1)
> - users: 4건
...
### 12. financial_details (상세 재무 데이터) - 10,355건
...
### 13. raymonds_index (자본 배분 효율성 지수 v2.1) - 7,646건
